...
NUM_EPOCHS = 1        # Changed to 1 since we only want the first checkpoint
...
def train_model(model, train_loader, val_loader, criterion, optimizer, num_epochs, early_stopping):
    ...
    for epoch in range(num_epochs):
        ...
        wandb.log({
            ...
            "train_positive_similarity": train_metrics['positive_similarity'],
            "train_negative_similarity": train_metrics['negative_similarity'],
        ...
        wandb.log({
            ...
            "val_positive_similarity": val_metrics['positive_similarity'],
            "val_negative_similarity": val_metrics['negative_similarity'],
            "val_triplet_accuracy": val_metrics['triplet_accuracy'],
            "epoch": epoch + 1
        })
        ...
        # Log to wandb that checkpoint was saved
        wandb.log({
        ...
        if epoch == 0:  # Stop after first epoch
            logging.info("\nStopping after first epoch as requested")
            break
